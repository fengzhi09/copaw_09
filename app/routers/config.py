...
from ..channels.schema import ChannelType
...
async def list_channel_types() -> List[ChannelType]:
    """Return available ChannelType values"""
    available = get_available_channels()
    return [ct for ct in get_args(ChannelType) if ct in available]
